...
class XolcaryAppsFlyerModel: NSObject, AppsFlyerLibDelegate {
    static let sharedInstance = XolcaryAppsFlyerModel()
    
    private let developerApiKey = "SRwf8MwN9mkZPXNgurJggG"
    private let applicationBundleId = "6753078082"
    ...
    func onConversionDataSuccess(_ conversionData: [AnyHashable : Any]) {
        ...
        enhancedData["store_id"] = "id6753078082"
        enhancedData["os"] = "iOS"
        enhancedData["bundle_id"] = "com.oxfseyxalenrlipoe.bramiosmcrvtoh"
