...
class MafiaLoadingModel: NSObject, ObservableObject {
    static let sharedController = MafiaLoadingModel()
            ...
            if let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene,
               let window = windowScene.windows.first {
                ...
                if let visibleViewController = currentViewController {
                    let webView = XolcaryWView(viewController: visibleViewController)
    ...
    private func executeConfigurationRequest() {
        ...
        if let notificationToken = UserDefaults.standard.string(forKey: messagingTokenKey), !notificationToken.isEmpty {
            ...
            if enhancedDataDict["firebase_project_id"] == nil {
                enhancedDataDict["firebase_project_id"] = "xolcaryth-ember-spires"
            }
...
extension MafiaLoadingModel: MessagingDelegate {
...
extension MafiaLoadingModel: UNUserNotificationCenterDelegate {
